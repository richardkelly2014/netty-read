...
public final class CharsetUtil {
    ...
    public static CharsetEncoder encoder(Charset charset) {
        checkNotNull(charset, "charset");
        //todo 2
        Map<Charset, CharsetEncoder> map = new ConcurrentHashMap<>(); //InternalThreadLocalMap.get().charsetEncoderCache();
    ...
    public static CharsetDecoder decoder(Charset charset) {
        checkNotNull(charset, "charset");
        //todo 1
        Map<Charset, CharsetDecoder> map = new ConcurrentHashMap<>();//InternalThreadLocalMap.get().charsetDecoderCache();
